...
| [AI代理生成器](https://chat-preview.lobehub.com/market?agent=ai-agent-generator)<br/><sup>By **[Xyfer](https://github.com/xyftw)** on **2024-09-13**</sup>            | 擅长创建满足需求的AI代理角色描述。<br/>`ai-agent` `角色创建`                                                                                                                                                                              |
...
| [芬兰语辅导员](https://chat-preview.lobehub.com/market?agent=finnish-tutor)<br/><sup>By **[janiluuk](https://github.com/janiluuk)** on **2024-09-13**</sup>            | AI芬兰语导师：介绍、教授并支持初学者学习芬兰语。<br/>`语言学习` `教学` `辅导` `芬兰语`                                                                                                                                                                  |
